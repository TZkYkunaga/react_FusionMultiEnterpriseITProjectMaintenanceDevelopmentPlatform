 ...
 *
 * - summarizeFeedback - A function that summarizes customer feedback.
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant helping to summarize customer feedback to quickly identify key issues and trends.  Please provide a concise summary of the following feedback:\n\nFeedback:\n{{feedbackText}}`,
});
